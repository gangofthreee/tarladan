...
class TruckerSettingsPage extends StatefulWidget {
  ...
  @override
  State<TruckerSettingsPage> createState() => _TruckerSettingsPageState();
}

class _TruckerSettingsPageState extends State<TruckerSettingsPage> {
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                // Tüm sayfaları temizle ve login'e git
